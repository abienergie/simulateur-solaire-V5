/*
  ...
  1. Changes
    ...
    - Add a trigger to automatically mark expired tokens as inactive
    - Update existing tokens to ensure only one valid token is active
    - Make sure the most recent valid token is marked as active
*/
