/*
  ...
  1. Table Structure Fix
    - Ensure `clients_identity` table exists with correct columns
...
-- If it exists with wrong structure, we'll recreate it
DO $$
BEGIN
  ...
  RAISE NOTICE 'clients_identity table created successfully with usage_point_id column';
END $$;