/*
  # Update battery prices table with automatic autoconsumption calculation

  1. Changes
    - Add generated column for autoconsumption_increase based on battery capacity
    - Values scale from 12% to 22% based on capacity ranges
